...
uint8_t CC1100::send_frame(uint8_t* frame, int len){ //mandar un paquete con longitud ilimitada
    /*La razon por la que frame es un puntero de uint es pq asi se le puede pasar directamente la direccion de memoria de la posicion del vector donde esta el siguiente byte a enviar cuando hay q seguir enviando.
